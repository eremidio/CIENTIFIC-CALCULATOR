...
"----------------------------------------------------------------\n"
"Menu de funções de operações de conversão de números para diferentes bases e funções de manipulação de bits de números inteiros. Use a seguinte notação para números escritos nas bases binária (0b...), octal (0...) e hexadecimal (0x...).\n Inserção de dados não conformes com estas notações podem acarretar erros lógicos no programa.\n"
...
"3.0 - ATALHOS DE TECLADO\n"
"----------------------------------------------------------------\n"
"Os seguintes atalhos de teclado estão disponíveis para ajuda:\n"
"'Ctrl+h' --> invoca o menu de ajuda.\n"
"'Alt+F4' --> encerra a aplicação.\n\n"
""
"4.0 - AGRADECIMENTOS\n"
"----------------------------------------------------------------\n\n"
